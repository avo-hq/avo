Avo::Engine.routes.draw do
  ...
  get "/:resource_name/:field_id/distribution_chart/full", to: "charts#distribution_chart_full", as: "distribution_chart_full"
  ...
  scope "resources", as: "resources" do
    ...
    # Actions
    get "/:resource_name(/:id)/actions/(:action_id)", to: "actions#show", as: "actions_show"
    post "/:resource_name(/:id)/actions/(:action_id)", to: "actions#handle", as: "actions_handle"
