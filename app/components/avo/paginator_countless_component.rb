...
class Avo::PaginatorCountlessComponent < ViewComponent::Base
  attr_reader :pagy_countless
  ...
  def initialize(resource: nil, parent_model: nil, pagy_countless: nil, turbo_frame: nil, index_params: nil, discreet_pagination: nil)
