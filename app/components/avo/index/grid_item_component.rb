...
class Avo::Index::GridItemComponent < Avo::BaseComponent
  ...
  def link_to_cover
    ...
    link_to helpers.blurhash_image_tag(@card[:cover_url], wrapper_class: "size-full", class: classes, canvas_class: classes), resource_view_path, class: classes, title: @card[:title], loading: :lazy, size: "640x480"
  end
