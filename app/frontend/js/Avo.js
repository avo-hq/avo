...
Vue.component('index-date-field',                require('@/js/components/Index/DateField.vue').default)
...
Vue.component('show-date-field',                 require('@/js/components/Show/DateField.vue').default)
...
Vue.component('edit-date-field',                 require('@/js/components/Edit/DateField.vue').default)
