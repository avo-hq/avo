...
RSpec.feature "create_through_record", type: :feature do
  ...
  describe "belongs_to comment" do
    let(:url) { "/admin/resources/comments/new?via_relation=user&via_resource_class=User&via_resource_id=#{admin.id}" }
  ...
  describe "has_many" do
    ...
    let(:url) { "/admin/resources/spouses/new?via_relation=spouses&via_resource_class=Person&via_resource_id=#{person.id}" }
  ...
  describe "has_many through" do
    ...
    let(:url) { "/admin/resources/users/new?via_relation=teams&via_resource_class=Team&via_resource_id=#{team.id}" }
  ...
  describe "has_and_belongs_to_many" do
    let(:url) { "/admin/resources/projects/new?via_relation=users&via_resource_class=User&via_resource_id=#{admin.id}" }
  ...
  describe "polymorphic" do
    ...
    let(:url) { "/admin/resources/comments/new?via_relation=commentable&via_resource_class=Project&via_resource_id=#{project.id}" }
