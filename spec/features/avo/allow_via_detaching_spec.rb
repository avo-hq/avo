...
RSpec.feature "AllowViaDetaching", type: :feature do
  describe "when allowed" do
    ...
    it "is enabled" do
      visit "/admin/resources/reviews/#{review.id}/edit?via_record_id=#{team.id}&via_relation=reviewable&via_resource_class=Avo::Resources::Team"
  ...
  describe "when disallowed" do
    ...
    it "is enabled" do
      visit "/admin/resources/comments/#{comment.id}/edit?via_record_id=#{post.id}&via_relation=commentable&via_resource_class=Avo::Resources::Post"
