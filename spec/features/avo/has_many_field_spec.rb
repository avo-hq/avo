  ...
  context "show" do
    ...
    describe "without a related post" do
      ...
      it "creates a post" do
        ...
        expect(page).to have_current_path "/admin/resources/posts/new?association_name=posts&via_record_id=#{user.slug}&via_relation=user&via_relation_class=User&via_resource_class=Avo%3A%3AResources%3A%3AUser"
    ...
    describe "with a related post" do
      ...
      it "displays valid links to resources" do
        ...
        # create new button
        expect(page).to have_link("Create new post", href: "/admin/resources/posts/new?association_name=posts&via_record_id=#{user.slug}&via_relation=user&via_relation_class=User&via_resource_class=Avo%3A%3AResources%3A%3AUser")
