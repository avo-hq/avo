  ...
  context "show" do
    ...
    describe "with a related post" do
      ...
      it "displays valid links to resources" do
        ...
        expect(page).to have_selector("[data-component-name='avo/ui/panel_component'] #{form}")
        ...
        expect(page).to have_selector("[data-component-name='avo/ui/panel_component'] #{form} button[data-control='detach'][data-resource-id='#{post.to_param}'][data-turbo-frame='has_many_field_posts']")
        ...
        expect(page).to have_selector("[data-component-name='avo/ui/panel_component'] #{form} button[data-control='destroy'][data-resource-id='#{post.to_param}'][data-turbo-frame='has_many_field_posts']")
      end
    end
  end
