...
RSpec.describe "Post comments use_resource PhotoComment", type: :feature do
  ...
  describe "tests" do
    ...
    it "if create new photo comment persist and attach" do
      ...
      expect(page).to have_current_path "/admin/resources/photo_comments/new?association_name=comments&via_record_id=#{post.slug}&via_relation=commentable&via_relation_class=Post&via_resource_class=Avo%3A%3AResources%3A%3APost"
