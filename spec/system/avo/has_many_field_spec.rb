  ...
  context 'show' do
    ...
    describe 'without a related post' do
      ...
      it 'creates a post' do
        ...
        expect(page).to have_current_path "/avo/resources/posts/new?viaRelationship=posts&viaResourceName=users&viaResourceId=#{user.id}"
    ...
    describe 'with a related post' do
      ...
      it 'navigates to a view post page' do
        ...
        expect(page).to have_current_path "/avo/resources/posts/#{post.id}?viaResourceName=users&viaResourceId=#{user.id}"
      end
