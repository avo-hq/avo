  ...
  context 'has_many_field' do
    ...
    describe 'with one page' do
      it 'should not have pagination' do
        visit "/admin/resources/courses/#{course_with_one_page_of_links.id}/links?turbo_frame=has_many_field_show_comments"
        wait_for_loaded
    ...
    describe 'with two pages' do
      it 'should have pagination' do
        visit "/admin/resources/courses/#{course_with_two_pages_of_links.id}/links?turbo_frame=has_many_field_show_comments"
        wait_for_loaded
