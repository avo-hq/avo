  ...
  describe "in a western (negative) Timezone", tz: "America/Chicago" do
    context "index" do
      it "displays the time" do
        ...
        expect(field_element_by_resource_id("posted_at", comment.id).text).to eq "10 February 1988 at 10:22 GMT-6"
      end
    end
    ...
    context "show" do
      it "displays the time" do
        ...
        expect(find_field_value_element("posted_at").text).to eq "10 February 1988 at 10:22 GMT-6"
      end
    end
    ...
    context "edit" do
      it "keeps the same value on save" do
        ...
        expect(hidden_input.value).to eq "1988-02-10 10:22:00"
        expect(text_input.value).to eq "1988-02-10 10:22:00"
      ...
      it "keeps the right value on update and save" do
        ...
        expect(field_element_by_resource_id("posted_at", comment.id).text).to eq "11 February 1988 at 11:17 GMT-6"
      end
    end
  end
end
