...
def uncheck_first_record
  find(:css, 'input[type="checkbox"][data-action="input->item-selector#toggle input->item-select-all#selectRow click->record-selector#toggleMultiple"]', match: :first).set(false)
