...
RSpec.describe 'Actions', type: :system do
  ...
  let!(:admin) { create :user, active: true, roles: { admin: true } }
  ...
  context 'index' do
    ...
    describe 'with actions attached' do
      ...
      it 'enables the button when selecting a record' do
        ...
        find("tr[data-resource-name=users][data-resource-id='#{user.id}'] input[type=checkbox]").click
      ...
      it 'runs the action' do
        ...
        find("tr[data-resource-name=users][data-resource-id='#{user.id}'] input[type=checkbox]").click
        find("tr[data-resource-name=users][data-resource-id='#{second_user.id}'] input[type=checkbox]").click
