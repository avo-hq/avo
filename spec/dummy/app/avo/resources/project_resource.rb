class ProjectResource < Avo::BaseResource
  ...
  field :country, as: :country, index_text_align: :left, html: {
    data: {
      action: 'input->resource-edit#atInput'
    }
  }
  field :users_required, as: :number, min: 10, max: 1000000, step: 1, index_text_align: :right
  field :started_at, as: :date_time, name: "Started", time_24hr: true, relative: true, timezone: "EET", nullable: true, html: {
    data: {
      action: 'input->resource-edit#atInput'
    }
  }
  ...
  field :meta, as: :key_value, key_label: "Meta key", value_label: "Meta value", action_text: "New item", delete_text: "Remove item", disable_editing_keys: false, disable_adding_rows: false, disable_deleting_rows: false, html: {
    data: {
      action: 'input->resource-edit#atInput'
    }
  }
