      ...
      default_values = get_fields
        ...
        .map do |field|
          ...
          if field.type == "belongs_to"
            ...
            if field.polymorphic_as.present? && field.types.map(&:to_s).include?(@params[:via_resource_class])
              # set the value to the actual record
              value = @params[:via_resource_class].safe_constantize.find(@params[:via_resource_id])
