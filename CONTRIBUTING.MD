...
You may use docker with the provided `docker-compose.yml` file, however, you will have to change the database credentials from port `5432` to `5433` so the app can connect to the docker-exposed postgres port.
