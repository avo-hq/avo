...
Make sure you have the latest migrations on the database layer too by running `RAILS_ENV=test bin/rails db:migrate`. This applies the migrations to the docker container that holds the database.
